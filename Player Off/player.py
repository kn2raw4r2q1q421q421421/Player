...
dpg.create_context()
dpg.create_viewport(title="MUSIC",large_icon="logo.ico",small_icon="logo.ico")
pygame.mixer.init()
...
def update_slider():
	...
	while pygame.mixer.music.get_busy():
		...
		time.sleep(0.7)
	state=None
	dpg.configure_item("cstate",default_value=f"Status: None")
...
with dpg.theme(tag="base"):
    with dpg.theme_component():
        ...
        dpg.add_theme_color(dpg.mvThemeCol_ButtonActive, (0, 150, 255, 95))  
        ...
        dpg.add_theme_color(dpg.mvThemeCol_ChildBg, (0, 120, 255))  
        dpg.add_theme_color(dpg.mvThemeCol_Border, (0, 120, 255, 0))  
        dpg.add_theme_color(dpg.mvThemeCol_ScrollbarBg, (0, 120, 255, 0))  
        dpg.add_theme_color(dpg.mvThemeCol_TitleBgActive, (0, 120, 255)) 
        dpg.add_theme_color(dpg.mvThemeCol_CheckMark, (0, 120, 255))  
        dpg.add_theme_color(dpg.mvThemeCol_FrameBgHovered, (0, 120, 255))  



with dpg.theme(tag="slider_thin"):
    with dpg.theme_component():
        dpg.add_theme_color(dpg.mvThemeCol_FrameBgActive, (0, 120, 255, 99))  
        dpg.add_theme_color(dpg.mvThemeCol_FrameBgHovered, (0, 120, 255, 99))  
        dpg.add_theme_color(dpg.mvThemeCol_SliderGrabActive, (255, 255, 255))  
        dpg.add_theme_color(dpg.mvThemeCol_SliderGrab, (255, 255, 255))  
        dpg.add_theme_color(dpg.mvThemeCol_FrameBg, (0, 120, 255, 99))  
...
with dpg.theme(tag="songs"):
    with dpg.theme_component():
        ...
        dpg.add_theme_color(dpg.mvThemeCol_Button, (0, 120, 255, 40))  
        dpg.add_theme_color(dpg.mvThemeCol_ButtonHovered, (0, 0, 255, 0))  
with dpg.font_registry():
	monobold = dpg.add_font("fonts/appetite-italic.ttf", 12)
	head = dpg.add_font("fonts/appetite-italic.ttf", 15)
...
with dpg.window(tag="main",label="window title"):
	...
	with dpg.group(horizontal=True):
		with dpg.child_window(width=200,tag="sidebar"):
			dpg.add_text("Build by Ilysha Trappe")
